      ...
      <div class="container text-center text-md-start mt-5">
        <div class="row mt-3">
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, temporibus. Voluptatibus rerum magnam eveniet nihil nisi earum ut commodi.
            </p>
          </div>
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">Home Articles</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Design</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Summer</a>
            </p>
          </div>
