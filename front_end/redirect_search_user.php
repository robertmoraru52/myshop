                ...
                <div class='col-xs-6'>
                    <div class='table-responsive'>
                        <table class='table table-hover table-inverse table-dark'>
                            ...
                            <tr>
                                <td><?php echo $_SESSION["search_id"]; ?></td>
                                <td><?php echo $_SESSION["search_created"]; ?></td>
                                <td><?php echo $_SESSION["search_email"]; ?></td>
                                <td>
                                    <form action='../back_end/delete_user_redirect.php'>
